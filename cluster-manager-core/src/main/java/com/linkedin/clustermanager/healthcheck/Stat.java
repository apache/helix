...
public class Stat {
	...
	public Stat(String opType, String measurementType,
	...
	public Stat(String opType, String measurementType,
			String resourceName, String partitionName, String nodeName, 
			String returnStatus, String metricName, AggregationType aggType) 
	{
		this._opType = opType;	
	...
	public int hashCode() 
	{
		return (_partitionName+_opType+_measurementType+
				_resourceName+_nodeName).hashCode();
	}
	...
	{
		return _nodeName+"."+_resourceName+"."+_partitionName+"."+_opType+"."+_measurementType+"."+_returnStatus+"."+_metricName+"."+_aggTypeName;
	}
}
