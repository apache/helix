...
import com.linkedin.clustermanager.model.ClusterView.MemberInstance;
        ...
        IZkStateListener
{
    ...
    public CallbackHandler(ClusterManager manager, ZkClient client,
            String path, Object listener, EventType[] eventTypes,
    ...
    public void invoke(NotificationContext changeContext) throws Exception
    {
        ...
        synchronized (_listener)
        {
            ...
            if (_changeType == IDEAL_STATE)
            {
                ...
                _accessor.getClusterView().setClusterPropertyList(ClusterPropertyType.IDEALSTATES, idealStates);
                idealStateChangeListener.onIdealStateChange(idealStates,
                        changeContext);
            ...
            else if (_changeType == CONFIG)
            {
                ...
                _accessor.getClusterView().setClusterPropertyList(ClusterPropertyType.CONFIGS, configs);
            ...
            else if (_changeType == LIVE_INSTANCE)
            {
                ...
                _accessor.getClusterView().setClusterPropertyList(ClusterPropertyType.LIVEINSTANCES, liveInstances);
            ...
            else if (_changeType == CURRENT_STATE)
            {
                ...
                instance = _accessor.getClusterView().getMemberInstance(
                        instanceName, true);
                instance.setInstanceProperty(InstancePropertyType.CURRENTSTATES, currentStates);
                currentStateChangeListener.onStateChange(instanceName,
                        currentStates, changeContext);
            ...
            else if (_changeType == MESSAGE)
            {
                ...
                memberInstance = _accessor.getClusterView().getMemberInstance(
                        instanceName, true);
                memberInstance.setInstanceProperty(InstancePropertyType.MESSAGES, messages);
                messageListener
                        .onMessage(instanceName, messages, changeContext);
