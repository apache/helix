...
public class MockControllerProcess
{
            ...
            JsonMappingException, InterruptedException, IOException
    {
        ...
        relayController.createExternalView(instanceNames, 10, 2, "EspressoDB",
                0);
        ...
        Thread.sleep(10000);
        storageController.sendMessage("TestMessageId2", "localhost_8900",
                "Slave", "Master", "EspressoDB.partition-0", 0);
        Thread.sleep(10000);
        storageController.sendMessage("TestMessageId3", "localhost_8900",
                "Master", "Slave", "EspressoDB.partition-0", 0);
        Thread.sleep(10000);
        ...
        storageController.sendMessage("TestMessageId4", "localhost_8900",
                "Slave", "Offline", "EspressoDB.partition-0", 0);
        Thread.sleep(10000);
    }
