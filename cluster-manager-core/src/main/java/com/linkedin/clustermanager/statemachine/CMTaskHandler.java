...
public class CMTaskHandler implements Callable<CMTaskResult>
{
            ...
            Message message, StateModel stateModel) throws Exception
    {
        ...
        if (!validateTask())
        {
            String errorMessage = "Invalid Message, ensure that message: "
    ...
    public CMTaskResult call() throws Exception
    {
        synchronized (_stateModel)
        {
            ...
            if (fromState == null
                    || !fromState.equalsIgnoreCase(_stateModel
                            .getCurrentState()))
            {
            ...
            try
            {
                ZNRecord currentState = accessor.getInstanceProperty(
            ...
            {
                logger.error("Error when updating the state on ZK", e);
                // TODO invoke on error method on the state model
            }
            return taskResult;
        }
    }
            ...
            InvocationTargetException
    {
        ...
        {
            methodToInvoke.invoke(_stateModel, new Object[] { _message,
