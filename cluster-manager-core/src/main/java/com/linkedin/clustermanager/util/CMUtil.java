...
public final class CMUtil
{
    ...
    public static String getClusterPropertyPath(String clusterName, ClusterPropertyType type)
    {
      return "/" + clusterName + "/" + type.toString();
    }
    
    public static String getInstancePropertyPath(String clusterName, String instanceName, InstancePropertyType type)
    {
    ...
    {
      return getClusterPropertyPath(clusterName, ClusterPropertyType.LIVEINSTANCES);
    }
    ...
    {
      return getInstancePropertyPath(clusterName, instanceName, InstancePropertyType.MESSAGES);
    }

    public static String getCurrentStatePath(String clusterName,
            String instanceName)
    {
      return getInstancePropertyPath(clusterName, instanceName, InstancePropertyType.CURRENTSTATES);
    }
    ...
    {
      return getClusterPropertyPath(clusterName, ClusterPropertyType.EXTERNALVIEW) + "/" + stateUnitGroup;
    }

    public static String getLiveInstancePath(String clusterName,
            String instanceName)
    {
      return getClusterPropertyPath(clusterName, ClusterPropertyType.LIVEINSTANCES) + "/" + instanceName;
    }
    ...
    {
      return getInstancePropertyPath(clusterName, instanceName, InstancePropertyType.ERRORS);
    }

    public static String getStatusUpdatesPath(String clusterName,
            String instanceName)
    {
      return getInstancePropertyPath(clusterName, instanceName, InstancePropertyType.STATUSUPDATES);
    }
