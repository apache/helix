...
public class TestZKCallback 
{
            ...
            IdealStateChangeListener
    {
        ...
        public void onStateChange(String instanceName,
                List<ZNRecord> statesInfo, NotificationContext changeContext)
        {
            // TODO Auto-generated method stub
    ...
    public void testInvocation() throws Exception
    {
        ...
        dataAccessor.setInstanceProperty("localhost_8900", InstancePropertyType.CURRENTSTATES, dummyRecord.getId(), dummyRecord);
        Thread.sleep(100);
        AssertJUnit.assertTrue(testListener.currentStateChangeReceived);
        testListener.Reset();

        dummyRecord.setId("db-1234");
        dataAccessor.setClusterProperty(ClusterPropertyType.IDEALSTATES, "db-1234", dummyRecord);
        Thread.sleep(100);
        AssertJUnit.assertTrue(testListener.idealStateChangeReceived);
        testListener.Reset();

        dummyRecord.setId("db-12345");
        dataAccessor.setClusterProperty(ClusterPropertyType.IDEALSTATES, "db-12345", dummyRecord);
        Thread.sleep(100);
        AssertJUnit.assertTrue(testListener.idealStateChangeReceived);
        testListener.Reset();
        ...
        dataAccessor.setInstanceProperty("localhost_8900", InstancePropertyType.MESSAGES, message.getId(), message);
        Thread.sleep(100);
        AssertJUnit.assertTrue(testListener.messageChangeReceived);

        dummyRecord.setId("localhost_9801");
        dataAccessor.setClusterProperty(ClusterPropertyType.LIVEINSTANCES, "localhost_9801", dummyRecord);
        Thread.sleep(100);
