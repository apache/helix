...
public class CustomizedViewComputeStage extends AbstractAsyncBaseStage {
  private static Logger LOG = LoggerFactory.getLogger(CustomizedViewComputeStage.class);
  ...
  private void computeCustomizedStateView(final Resource resource, final String stateType,
    ...
    for (Partition partition : resource.getPartitions()) {
      Map<String, String> customizedStateMap =
          customizedStateOutput.getCustomizedStateMap(stateType, resourceName, partition);
