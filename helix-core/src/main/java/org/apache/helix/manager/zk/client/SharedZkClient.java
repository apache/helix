 ...
 */
@Deprecated
class SharedZkClient extends org.apache.helix.zookeeper.api.factory.SharedZkClient {
  /**
  ...
  protected SharedZkClient(ZkConnectionManager connectionManager, ZkClientConfig clientConfig,
      org.apache.helix.zookeeper.api.factory.SharedZkClient.OnCloseCallback callback) {
