...
public class TestCustomizedStateComputationStage extends BaseStageTest {
  ...
  public void testEmptyCustomizedState() {
    ...
    AssertJUnit.assertEquals(output
        .getCustomizedStateMap(CUSTOMIZED_STATE_NAME, RESOURCE_NAME, new Partition("testResourceName_0")).size(), 0);
  }
  ...
  public void testSimpleCustomizedState() {
    ...
    AssertJUnit.assertEquals(
        output1.getCustomizedStateMap(CUSTOMIZED_STATE_NAME, RESOURCE_NAME, new Partition(PARTITION_NAME)).size(), 0);
    ...
    AssertJUnit.assertEquals(output2.getCustomizedState(CUSTOMIZED_STATE_NAME, RESOURCE_NAME, partition, INSTANCE_NAME),
        "STARTED");
  }
}
