...
public class TestWagedClusterExpansion extends ZkTestBase {
  ...
  private static final Logger LOG = LoggerFactory.getLogger("TestWagedClusterExpansion");
  ...
  public static class WagedMasterSlaveModel extends StateModel {
    ...
    public void onBecomeOfflineFromSlave(Message message, NotificationContext context) {
      ...
      LOG.error("Become OFFLINE from SLAVE");
    }
    ...
    public void onBecomeDroppedFromOffline(Message message, NotificationContext context) {
      ...
      LOG.error("Become DROPPED FROM OFFLINE");
    }
  }
  ...
  public void testIncreaseResourcePartitionWeight() throws Exception {
    ...
    LOG.error("KKD-After adding the new instance");
    ...
    LOG.error("After changing resource partition weight");
  ...
  private void validateIdealState(boolean afterWeightChange) {
    ...
    for (String instance : instanceToPartitionMap.keySet()) {
      ...
      LOG.error("\tIntance: " + instance + " used capacity: " + usedInstanceCapacity);
  ...
  private void printCurrentState() {
    ...
    for (String instance : instances) {
      ...
      for (CurrentState currentState : currentStates) {
        LOG.error("\t" + currentState.getRecord().getMapFields().keySet().toString());
      }
    }
  }
}
