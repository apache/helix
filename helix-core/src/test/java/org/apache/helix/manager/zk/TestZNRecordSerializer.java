...
public class TestZNRecordSerializer {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(TestZNRecordSerializer.class);
  ...
  public void testPerformance() {
    ...
    LOG.info("ZNRecordSerializer serialize took " + (System.currentTimeMillis() - start) + " ms");
    ...
    LOG.info("ZNRecordSerializer deserialize took " + (System.currentTimeMillis() - start) + " ms");
    ...
    LOG.info("ZNRecordStreamingSerializer serialize took " + (System.currentTimeMillis() - start) + " ms");

    start = System.currentTimeMillis();
    for (int i = 0; i < loop; i++) {
      ZNRecord result = (ZNRecord) serializer2.deserialize(data);
    }
    LOG.info("ZNRecordStreamingSerializer deserialize took " + (System.currentTimeMillis() - start) + " ms");
  }
