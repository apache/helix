 ...
 */
   ...
   * Delete the path as well as all its children.
   * @param path
   * @throws ZkScaleException
   */
  public void deleteRecursively(String path) throws ZkScaleException {
    ...
    try {
      ...
      throw new ZkScaleException("Failed to delete " + path, e);
    }
  }
