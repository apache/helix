package org.apache.helix.metadatastore.server.common;
...
public class RestNamespace {
  ...
  public enum MetadataStoreType {
    ZOOKEEPER, NO_METADATA_STORE
  }

  public enum RestNamespaceProperty {
    NAME, METADATA_STORE_TYPE, METADATA_STORE_ADDRESS, IS_DEFAULT
  }
   ...
   */
  private MetadataStoreType _metadataStoreType;
  ...
  public RestNamespace(String metadataStoreAddress) throws IllegalArgumentException {
    this(DEFAULT_NAMESPACE_NAME, MetadataStoreType.ZOOKEEPER, metadataStoreAddress, true);
  }

  public RestNamespace(String name, MetadataStoreType metadataStoreType,
  ...
  private void validate() throws IllegalArgumentException {
    ...
    if (_metadataStoreType != MetadataStoreType.NO_METADATA_STORE && (_metadataStoreAddress == null
        || _metadataStoreAddress.isEmpty())) {
      throw new IllegalArgumentException(String
          .format("Metadata store address \"%s\" is not valid for namespace %s",
              _metadataStoreAddress, _name));
    }
  }
  ...
  public Map<String, String> getRestInfo() {
    ...
    ret.put(RestNamespaceProperty.NAME.name(), _name);
    ret.put(RestNamespaceProperty.IS_DEFAULT.name(), String.valueOf(_isDefault));
    return ret;
  }
}
