...
import org.apache.helix.metadatastore.server.resources.metadatastore.MetadataStoreDirectoryAccessor;
...
public enum ServletType {
   ...
   */
  DEFAULT_SERVLET(RestNamespace.DEFAULT_NAMESPACE_PATH_SPEC,
      new String[] {
