package org.apache.helix.metadatastore.server.filters;
...
import org.apache.helix.metadatastore.server.auditlog.AuditLog;
...
public class AuditLogFilter implements ContainerRequestFilter, ContainerResponseFilter {
  ...
  public void filter(ContainerRequestContext request) throws IOException {
    ...
    auditLogBuilder.namespace(getNamespace()).requestPath(request.getUriInfo().getPath())
        .httpMethod(request.getMethod()).startTime(new Date())
  ...
  private String getNamespace() {
    ...
    return RestUtils.getNamespaceFromServletPath(servletPath);
  }
}
