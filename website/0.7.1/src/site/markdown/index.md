...
<head>
  <title>Helix 0.7.1 Documentation [BETA]</title>
</head>
...
[Release Notes](./releasenotes/release-0.7.1.html)
...
[Javadocs](http://helix.apache.org/javadocs/0.7.1/index.html)
...
### Beta!
This release contains many new features, but some APIs are still in the process of being finalized.
