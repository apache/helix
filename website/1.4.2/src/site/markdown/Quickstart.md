...
Download the 1.4.2 release package [here](./download.html)
...
```
java -cp zookeeper-3.3.3-ZooInspector.jar:lib/jtoaster-1.4.2.jar:../../lib/log4j-1.2.15.jar:../../zookeeper-3.3.3.jar org.apache.zookeeper.inspector.ZooInspector
```
