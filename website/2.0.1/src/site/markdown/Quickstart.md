...
Download the 2.0.1 release package [here](./download.html)
...
```
java -cp zookeeper-3.3.3-ZooInspector.jar:lib/jtoaster-2.0.0.jar:../../lib/log4j-1.2.15.jar:../../zookeeper-3.3.3.jar org.apache.zookeeper.inspector.ZooInspector
```
