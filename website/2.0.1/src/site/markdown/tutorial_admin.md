...
* REST Interface via helix-rest (helix-admin-webapp is deprecated in 2.0.0)
...
The helix-admin-webapp module has been deprecated in Helix 2.0.0 and will be removed in a future release. Users should use the Helix Gateway service for programmatic cluster management.

For legacy reference, the REST interface was available via helix-admin-webapp package:
