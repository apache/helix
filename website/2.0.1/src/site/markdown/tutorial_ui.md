...
The helix-front module has been deprecated in Helix 2.0.0 and will be removed in a future release. Users should migrate to alternative solutions for cluster management and monitoring.

For legacy reference, the helix-front module provided a web UI for Helix cluster management.

### Historical Features (Deprecated)

The following features were supported via Helix UI:
