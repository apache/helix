...
* [0.8.2](./0.8.2-docs/index.html) - A release focusing on performance improvement backward compatible with 0.6.x.

    [\[Quick Start\]](./0.8.2-docs/Quickstart.html) [\[Release Notes\]](./0.8.2-docs/releasenotes/release-0.8.2.html)
...
<a href="./0.8.2-docs/download.html" class="btn btn-primary btn-small">0.8.2</a>
